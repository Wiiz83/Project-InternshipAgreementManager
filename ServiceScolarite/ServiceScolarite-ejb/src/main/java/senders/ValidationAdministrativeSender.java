...
import miage.iae.projet.shared.messages.validations.ValidationAdministrative;
...
public class ValidationAdministrativeSender {
    ...
    public void envoyerValidationPedagogique(ValidationAdministrative validation) {
